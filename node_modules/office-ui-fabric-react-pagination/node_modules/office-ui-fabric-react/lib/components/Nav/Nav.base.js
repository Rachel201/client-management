...
var NavBase = /** @class */ (function (_super) {
    ...
    function NavBase(props) {
        ...
        _this._onRenderLink = function (link) {
            var _a = _this.props, getStyles = _a.getStyles, groups = _a.groups, theme = _a.theme;
        ...
        _this._renderGroup = function (group, groupIndex) {
            ...
            return (React.createElement("div", { key: groupIndex, className: classNames.group },
                (group.name ?
                    React.createElement("button", { className: classNames.chevronButton, onClick: _this._onGroupHeaderClicked.bind(_this, group) },
    ...
    NavBase.prototype.render = function () {
        ...
        return (React.createElement(FocusZone_1.FocusZone, { direction: FocusZone_1.FocusZoneDirection.vertical, ref: this._focusZone },
    ...
    NavBase.prototype._renderNavLink = function (link, linkIndex, nestingLevel) {
        ...
        return (React.createElement(Button_1.ActionButton, { className: classNames.link, styles: Nav_styles_1.buttonStyles, href: link.url || (link.forceAnchor ? 'javascript:' : undefined), iconProps: link.iconProps || { iconName: link.icon || '' }, ariaDescription: link.title || link.name, onClick: link.onClick ? this._onNavButtonLinkClicked.bind(this, link) : this._onNavAnchorLinkClicked.bind(this, link), title: link.title || link.name, target: link.target, rel: rel, "aria-label": link.ariaLabel }, onRenderLink(link, this._onRenderLink)));
    };
