...
export var DatePickerStyles = function (props) {
    ...
    var HoverStyles = function () {
        return {
            ...
            '.ms-DatePicker-day--infocus:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-currentDecade:hover': { color: semanticColors.bodyText },
            '.ms-DatePicker-day--outfocus:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-monthAndYear:hover': { color: semanticColors.bodyText },
            '.ms-DatePicker-weekday:hover': { color: semanticColors.bodyText },
            '.ms-DatePicker-monthOption:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-header > .ms-DatePicker-currentYear:hover': { color: semanticColors.bodyText },
            '.ms-DatePicker-prevMonth:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-nextMonth:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-prevYear:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-nextYear:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-goToday:hover': {},
            '.ms-DatePicker-yearOption:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-prevDecade:hover': __assign({}, TextHoverStyle()),
            '.ms-DatePicker-nextDecade:hover': __assign({}, TextHoverStyle()),
        };
    };
    return {
        ...
        callout: {
            ...
            color: semanticColors.bodyText,
            selectors: __assign(__assign({ '.ms-Callout-main': {
                    backgroundColor: semanticColors.bodyBackground,
