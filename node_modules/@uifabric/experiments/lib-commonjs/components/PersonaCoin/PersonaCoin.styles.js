...
exports.PersonaCoinStyles = function (props, theme, tokens) {
    ...
    var _a = props.size, size = _a === void 0 ? exports.DEFAULT_PERSONA_COIN_SIZE : _a, _b = props.coinColor, coinColor = _b === void 0 ? Persona_1.getPersonaInitialsColor(personaProps) : _b, _c = props.initialsColor, initialsColor = _c === void 0 ? 'white' : _c;
    return {
        root: {
            position: 'relative',
