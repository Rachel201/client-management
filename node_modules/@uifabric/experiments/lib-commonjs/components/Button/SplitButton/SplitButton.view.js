...
/** @deprecated */
exports.SplitButtonSlots = function (props) { return ({
    root: 'span',
...
/** @deprecated */
exports.SplitButtonView = function (props, slots) {
    ...
    var _a = tokens, contentPadding = _a.contentPadding, contentPaddingFocused = _a.contentPaddingFocused, secondaryPadding = _a.secondaryPadding, splitButtonTokens = tslib_1.__rest(_a, ["contentPadding", "contentPaddingFocused", "secondaryPadding"]);
    ...
    var buttonTokens = primaryActionDisabled
        ? tslib_1.__assign({ contentPadding: contentPadding, contentPaddingFocused: contentPaddingFocused }, nonColoredButtonTokens) : tokens;
    var menuButtonTokens = tslib_1.__assign({ contentPadding: secondaryPadding }, splitButtonTokens);
    return (Foundation_1.withSlots(slots.root, null,
        Foundation_1.withSlots(slots.button, tslib_1.__assign({ primary: primary, disabled: primaryActionDisabled || disabled, allowDisabledFocus: allowDisabledFocus, ariaLabel: ariaLabel, onClick: onClick, componentRef: buttonRef, content: content, onKeyDown: onKeyDown, tokens: buttonTokens }, rest), children),
        Foundation_1.withSlots(slots.splitDividerContainer, null,
            Foundation_1.withSlots(slots.splitDivider, null)),
        Foundation_1.withSlots(slots.menuButton, { primary: primary, disabled: disabled, defaultExpanded: defaultExpanded, expanded: expanded, allowDisabledFocus: allowDisabledFocus, ariaLabel: menuButtonAriaLabel, onClick: onSecondaryActionClick, componentRef: menuButtonRef, keytipProps: keytipProps, menu: menu, onKeyDown: onKeyDown, onMenuDismiss: onMenuDismiss, tokens: menuButtonTokens })));
};
