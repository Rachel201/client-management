...
var TileStylesModule = require("./Tile.scss");
var SignalStylesModule = require("../signals/Signal.scss");
var CheckStylesModule = require("office-ui-fabric-react/lib-commonjs/components/Check/Check.scss");
...
var Tile = /** @class */ (function (_super) {
    ...
    Tile.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ "aria-selected": isSelected }, Utilities_1.getNativeProps(divProps, Utilities_1.divProperties), { "aria-labelledby": ariaLabel ? this._labelId : this._nameId, "aria-describedby": ariaLabelWithSelectState ? this._descriptionId : this._activityId, className: Utilities_1.css('ms-Tile', className, TileStyles.tile, (_a = {},
            ...
            link,
            descriptionAriaLabel ? (React.createElement("span", { key: "description", id: this._descriptionId, className: Utilities_1.css('ms-Tile-description', TileStylesModule.description) }, descriptionAriaLabel)) : null,
            isSelectable
                ? this._onRenderCheck({
                    isSelected: isSelected,
                })
