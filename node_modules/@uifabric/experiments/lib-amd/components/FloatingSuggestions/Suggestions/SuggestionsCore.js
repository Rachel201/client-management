define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "./SuggestionsItem", "./SuggestionsCore.scss"], function (require, exports, tslib_1, React, Utilities_1, SuggestionsItem_1, stylesImport) {
    "use strict";
    ...
    var SuggestionsCore = /** @class */ (function (_super) {
        ...
        SuggestionsCore.prototype.render = function () {
            ...
            return (React.createElement("div", { className: Utilities_1.css('ms-Suggestions-container', styles.suggestionsContainer), id: "suggestion-list", role: "list", "aria-label": suggestionsContainerAriaLabel }, suggestions.map(function (suggestion, index) { return (React.createElement("div", { ref: suggestion.selected || index === _this.currentIndex ? _this._selectedElement : undefined, key: hasKey(suggestion.item) ? suggestion.item.key : index, id: 'sug-' + index, role: "listitem", "aria-label": suggestion.ariaLabel },
                React.createElement(SuggestionsItem_1.SuggestionsItem, { id: 'sug-item' + index, suggestionModel: suggestion, onRenderSuggestion: onRenderSuggestion, onClick: _this._onClickTypedSuggestionsItem(suggestion.item, index), className: suggestionsItemClassName, showRemoveButton: showRemoveButtons, onRemoveItem: _this._onRemoveTypedSuggestionsItem(suggestion.item, index), isSelectedOverride: index === _this.currentIndex }))); })));
        };
