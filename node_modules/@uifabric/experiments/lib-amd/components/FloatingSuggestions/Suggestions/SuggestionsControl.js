define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "./SuggestionsCore", "./SuggestionsControl.scss"], function (require, exports, tslib_1, React, Utilities_1, SuggestionsCore_1, stylesImport) {
    "use strict";
    ...
    var SuggestionsControl = /** @class */ (function (_super) {
        ...
        SuggestionsControl.prototype.componentDidUpdate = function (prevProps, prevState) {
            this.scrollSelected();
        };
        ...
        Object.defineProperty(SuggestionsControl.prototype, "currentSuggestion", {
            get: function () {
                var _a;
                return (_a = this._suggestions.current) === null || _a === void 0 ? void 0 : _a.getCurrentItem();
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(SuggestionsControl.prototype, "selectedElement", {
            get: function () {
                var _a;
                return (_a = this._suggestions.current) === null || _a === void 0 ? void 0 : _a.selectedElement;
            },
            enumerable: true,
            configurable: true
        });
        ...
        SuggestionsControl.prototype._renderHeaderItems = function () {
            var _this = this;
        ...
        SuggestionsControl.prototype._renderFooterItems = function () {
            var _this = this;
        ...
        SuggestionsControl.prototype._renderSuggestions = function () {
            return React.createElement(SuggestionsCore_1.SuggestionsCore, tslib_1.__assign({ ref: this._suggestions }, this.props, { suggestions: this.state.suggestions }));
        };
        /**
         * Selects the next selectable item
         */
        SuggestionsControl.prototype._selectNextItem = function (itemType, originalItemType) {
         ...
         */
        SuggestionsControl.prototype._selectPreviousItem = function (itemType, originalItemType) {
            // If the recursive calling has not found a selectable item in the other suggestion item type groups
            // And the method is being called again with the original item type,
         ...
         */
        SuggestionsControl.prototype._resetSelectedItem = function () {
            var _a;
         ...
         */
        SuggestionsControl.prototype._selectFirstItem = function () {
         ...
         */
        SuggestionsControl.prototype._selectLastItem = function () {
