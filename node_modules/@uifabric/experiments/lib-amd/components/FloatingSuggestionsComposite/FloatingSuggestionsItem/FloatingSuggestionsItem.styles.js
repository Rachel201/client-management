define(["require", "exports", "tslib", "@uifabric/styling"], function (require, exports, tslib_1, styling_1) {
    "use strict";
        ...
        return {
            ...
            closeButton: [
                classNames.closeButton,
                {
                    ...
                    selectors: {
                        ':hover': (_d = {},
                            _d[styling_1.HighContrastSelector] = tslib_1.__assign({ background: 'Window', color: 'WindowText' }, styling_1.getHighContrastNoAdjustStyle()),
                            _d),
                    },
                },
                isSelected && [
                    classNames.isSelected,
                    {
                        ...
                        selectors: (_e = {
                            ...
                            _e[styling_1.HighContrastSelector] = tslib_1.__assign({ background: 'Highlight', color: 'HighlightText' }, styling_1.getHighContrastNoAdjustStyle()),
                            _e),
                    },
                ],
            ],
