define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "./SignalField.scss"], function (require, exports, tslib_1, React, Utilities_1, SignalFieldStyles) {
    ...
    exports.SignalField = function (props) {
        var _a;
        var before = props.before, after = props.after, className = props.className, _b = props.signalsFieldMode, signalsFieldMode = _b === void 0 ? 'compact' : _b, spanProps = tslib_1.__rest(props, ["before", "after", "className", "signalsFieldMode"]);
        return (React.createElement("span", tslib_1.__assign({}, spanProps, { className: Utilities_1.css(SignalFieldStyles.signalField, (_a = {},
