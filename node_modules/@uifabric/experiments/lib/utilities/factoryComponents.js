...
import { FontIcon as FabricFontIcon, Icon as FabricIcon, Label as FabricLabel, } from 'office-ui-fabric-react';
...
export var FontIcon = function (props) {
    return props.iconName ? React.createElement(FabricFontIcon, __assign({}, props)) : null;
};
FontIcon.displayName = 'FontIcon';
var fontIconFactory = createFactory(FontIcon, { defaultProp: 'iconName' });
FontIcon.create = fontIconFactory;
export var Icon = function (props) {
    return props.iconName ? React.createElement(FabricIcon, __assign({}, props)) : null;
};
Icon.displayName = 'Icon';
var iconFactory = createFactory(Icon, { defaultProp: 'iconName' });
Icon.create = iconFactory;
export var Label = function (props) {
    return React.Children.count(props.children) > 0 ? React.createElement(FabricLabel, __assign({}, props)) : null;
};
Label.displayName = 'Label';
var labelFactory = createFactory(Label);
...
function (props) { return (props.presence !== undefined ? React.createElement(FabricPersonaPresence, __assign({}, props)) : null); };
PersonaPresence.displayName = 'PersonaPresence';
var personaPresenceFactory = createFactory(PersonaPresence, {
