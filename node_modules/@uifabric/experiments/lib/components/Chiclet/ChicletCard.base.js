...
var customPreviewStyling = mergeStyles('ms-ChicletCard-preview-custom', {
    height: 112,
    width: '100%',
    objectFit: 'contain',
});
...
var ChicletCardBase = /** @class */ (function (_super) {
    __extends(ChicletCardBase, _super);
    function ChicletCardBase() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ChicletCardBase.prototype.render = function () {
        var _a = this.props, title = _a.title, description = _a.description, url = _a.url, onClick = _a.onClick, className = _a.className, footer = _a.footer, theme = _a.theme, styles = _a.styles;
        ...
        return (React.createElement("div", { tabIndex: tabIndex, role: role, onClick: onClick, className: this._classNames.root },
            ...
            React.createElement("div", { className: this._classNames.info },
                React.createElement("div", { className: this._classNames.title }, title),
                React.createElement("div", { className: this._classNames.description }, description ? description : url),
                footer)));
    };
    ChicletCardBase.prototype._renderPreview = function () {
