...
export declare const enum TilesGridMode {
    /**
...
export interface ITilesListProps<TItem> extends IBaseProps, React.Props<TilesList<TItem>>, // eslint-disable-line deprecation/deprecation
