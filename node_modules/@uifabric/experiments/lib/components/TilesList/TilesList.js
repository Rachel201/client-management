...
import { css, FocusRects, composeRenderFunction, } from 'office-ui-fabric-react/lib/Utilities';
...
var TilesList = /** @class */ (function (_super) {
    ...
    function TilesList(props, context) {
        ...
        _this._onRenderListRoot = function (props, defaultRender) {
            ...
            var baseOnRenderRoot = function (baseProps) {
                return defaultRender(__assign(__assign({}, props), { divProps: __assign(__assign({}, props.divProps), baseProps.divProps), surfaceElement: baseProps.surfaceElement }));
            };
            var finalOnRenderRoot = onRenderRoot ? composeRenderFunction(onRenderRoot, baseOnRenderRoot) : baseOnRenderRoot;
        ...
        _this._onRenderPage = function (pageProps, defaultRender) {
            ...
            var finalOnRenderRow = onRenderRow ? composeRenderFunction(onRenderRow, _this._renderRow) : _this._renderRow;
            ...
            var _loop_1 = function (i) {
                ...
                var _loop_2 = function () {
                    ...
                    var renderedCell = function (keyOffset) {
                        ...
                        return (React.createElement("div", { key: grid.key + "-item-" + cell.key + (keyOffset ? '-' + keyOffset : ''), "data-list-index": index, role: role ? 'presentation' : 'listitem', className: css('ms-List-cell', _this._onGetCellClassName(), (_a = {},
                                _a["ms-TilesList-cell--firstInRow " + TilesListStyles.cellFirstInRow] = !!cellAsFirstRow,
                                _a)), "data-automationid": "ListCell", style: __assign({}, _this._onGetCellStyle(cell, currentRow)) }, _this._onRenderCell(cell, finalSize, columnIndex + keyOffset)));
                    };
                ...
                if (currentRowCells.length > 0) {
                    renderedCells.push(finalOnRenderRow({
                        cellElements: currentRowCells,
                        divProps: {
                            className: css(TilesListStyles.row, (_a = {},
                ...
                var finalGrid = (React.createElement("div", { key: grid.key, role: "presentation", className: css('ms-TilesList-grid', (_b = {},
                ...
                grids.push(isPlaceholder ? React.createElement(Shimmer, { key: i, customElementsGroup: finalGrid, width: shimmerWrapperWidth }) : finalGrid);
                out_i_1 = i;
            };
            var out_i_1;
            ...
            return (React.createElement("div", __assign({ role: "presentation" }, divProps, { className: css(pageClassName, _this._onGetPageClassName()) }), grids));
        };
        /**
        ...
        _this._renderRow = function (props) {
            ...
            return (React.createElement("div", __assign({ role: "presentation" }, divProps), cellElements));
        };
    ...
    TilesList.prototype.render = function () {
        ...
        var _a = this.props, className = _a.className, onActiveElementChanged = _a.onActiveElementChanged, items = _a.items, cellsPerPage = _a.cellsPerPage, ref = _a.ref, role = _a.role, focusZoneComponentRef = _a.focusZoneComponentRef, _b = _a.listProps, listProps = _b === void 0 ? {} : _b, divProps = __rest(_a, ["className", "onActiveElementChanged", "items", "cellsPerPage", "ref", "role", "focusZoneComponentRef", "listProps"]);
        var onRenderRoot = listProps.onRenderRoot, onRenderPage = listProps.onRenderPage, otherListProps = __rest(listProps, ["onRenderRoot", "onRenderPage"]);
        ...
        var finalOnRenderPage = onRenderPage
            ...
            : this._onRenderPage;
        return (React.createElement(FocusZone, __assign({}, divProps, { ref: ref, componentRef: focusZoneComponentRef, className: css('ms-TilesList', className), direction: FocusZoneDirection.bidirectional, onActiveElementChanged: this.props.onActiveElementChanged }),
            React.createElement(FocusRects, null),
            React.createElement(List, __assign({ items: cells, role: role, onRenderRoot: finalOnRenderRoot, getPageSpecification: this._getPageSpecification, onRenderPage: finalOnRenderPage, ref: this.listRef, usePageCache: true }, otherListProps))));
    };
    TilesList.prototype.scrollToIndex = function (index, mode) {
        var _this = this;
        if (mode === void 0) { mode = ScrollToMode.auto; }
    ...
    TilesList.prototype._onRenderCell = function (item, finalSize, column) {
        if (item.grid.mode === 0 /* none */) {
            return (React.createElement("div", { role: "presentation", className: css(TilesListStyles.header) }, item.onRender({
                item: item.content,
        ...
        return (React.createElement("div", { role: "presentation", className: css(TilesListStyles.cell), style: item.grid.mode === 3 /* fillHorizontal */
                ? {
            ...
            React.createElement("div", { role: "presentation", className: css(TilesListStyles.cellContent) }, item.onRender({
                item: item.content,
                finalSize: finalSize,
                position: {
                    column: column,
