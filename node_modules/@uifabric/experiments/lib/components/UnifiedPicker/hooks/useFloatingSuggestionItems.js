...
export var useFloatingSuggestionItems = function (floatingSuggestionItems, footerSuggestionItems, headerSuggestionItems, focusSuggestionIndex, focusFooterIndex, focusHeaderIndex, isSuggestionsVisible, initialQueryString) {
    ...
    var removeSuggestion = function (index) {
        var currentSuggestions = __spreadArrays(suggestionItems);
