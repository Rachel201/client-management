 ...
 */
export var DefaultEditingItemInner = function (props) {
    var _a, _b;
    ...
    return (React.createElement("span", { "aria-labelledby": 'editingItemPersona-' + itemId, className: css('ms-EditingItem', styles.editingContainer) },
        React.createElement("input", __assign({}, nativeProps, { ref: editingInput, autoCapitalize: 'off', autoComplete: 'off', onChange: _onInputChange, onKeyDown: _onInputKeyDown, onBlur: _onInputBlur, "data-lpignore": true, className: styles.editingInput, id: itemId })),
        _renderEditingSuggestions()));
};
export var DefaultEditingItem = function (outerProps) { return function (innerProps) { return React.createElement(DefaultEditingItemInner, __assign({}, outerProps, innerProps)); }; };
