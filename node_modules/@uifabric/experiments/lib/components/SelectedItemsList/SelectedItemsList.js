...
var _SelectedItemsList = function (props, ref) {
    ...
    var removeItems = function (itemsToRemove) {
        ...
        var updatedItems = __spreadArrays(items);
    ...
    var _replaceItem = React.useCallback(function (newItem, index) {
        ...
        if (index >= 0) {
            ...
            newItems.splice.apply(newItems, __spreadArrays([index, 1], newItemsArray));
            setItems(newItems);
...
export var SelectedItemsList = React.forwardRef(_SelectedItemsList);
