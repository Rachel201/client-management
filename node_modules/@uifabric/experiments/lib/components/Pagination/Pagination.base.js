...
var PaginationBase = /** @class */ (function (_super) {
    ...
    PaginationBase.prototype.render = function () {
        ...
        if (format === 'comboBox') {
            ...
            return (React.createElement("div", { className: this._classNames.root },
                React.createElement(IconButton, { iconProps: firstPageIconProps, onClick: this._handleFirstPage, disabled: !canFirst, "aria-label": firstPageAriaLabel }),
                React.createElement(IconButton, { iconProps: previousPageIconProps, onClick: this._handlePreviousPage, disabled: !canPrevious, "aria-label": previousPageAriaLabel }),
                React.createElement(ComboBox, { ariaLabel: comboBoxAriaLabel, selectedKey: "" + selectedPageIndex, options: scaleOptions, onChange: this._onComboBoxChange, styles: {
                        container: this._classNames.comboBox,
                    } }),
                React.createElement(IconButton, { iconProps: nextPageIconProps, onClick: this._handleNextPage, disabled: !canNext, "aria-label": nextPageAriaLabel }),
                React.createElement(IconButton, { iconProps: lastPageIconProps, onClick: this._handleLastPage, disabled: !canLast, "aria-label": lastPageAriaLabel })));
        }
        return (React.createElement("div", { className: this._classNames.root },
            React.createElement("div", null,
                React.createElement(IconButton, { iconProps: this.props.firstPageIconProps, onClick: this._handleFirstPage, disabled: !canFirst, "aria-label": firstPageAriaLabel, styles: {
                        icon: this._classNames.previousNextPage,
                        rootDisabled: this._classNames.previousNextPageDisabled,
                    } }),
                React.createElement(IconButton, { iconProps: this.props.previousPageIconProps, onClick: this._handlePreviousPage, disabled: !canPrevious, "aria-label": previousPageAriaLabel, styles: {
                        icon: this._classNames.previousNextPage,
                        rootDisabled: this._classNames.previousNextPageDisabled,
                    } }),
                this._pageList(),
                React.createElement(IconButton, { iconProps: this.props.nextPageIconProps, onClick: this._handleNextPage, disabled: !canNext, "aria-label": nextPageAriaLabel, styles: {
                        icon: this._classNames.previousNextPage,
                        rootDisabled: this._classNames.previousNextPageDisabled,
                    } }),
                React.createElement(TooltipHost, { content: "" + (pageAriaLabel ? pageAriaLabel + ' ' : '') + pageCount, directionalHint: DirectionalHint.bottomCenter },
                    React.createElement(IconButton, { iconProps: this.props.lastPageIconProps, onClick: this._handleLastPage, disabled: !canLast, "aria-label": lastPageAriaLabel, styles: {
                            icon: this._classNames.previousNextPage,
                            rootDisabled: this._classNames.previousNextPageDisabled,
                        } }))),
    ...
    PaginationBase.prototype._pageElement = function (index) {
        ...
        return (React.createElement(PageNumber, { key: index + 1, page: index + 1, ariaLabel: ariaLabel, selected: isSelected, onClick: this._handleSelectedPage, className: this._classNames.pageNumber }));
    };
