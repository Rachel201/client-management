define(["require", "exports", "tslib", "@fluentui/theme", "./variantThemeType"], function (require, exports, tslib_1, theme_1, variantThemeType_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function makeThemeFromPartials(originalTheme, partialPalette, partialSemantic) {
        // Create variant palette
        var variantTheme = theme_1.createTheme({ palette: tslib_1.__assign(tslib_1.__assign({}, originalTheme.palette), partialPalette) });
        // Change semantic colors to use updated variant palette values
        variantTheme.semanticColors = tslib_1.__assign(tslib_1.__assign({}, variantTheme.semanticColors), partialSemantic);
        // Fill in the rest of the theme
        variantTheme = tslib_1.__assign(tslib_1.__assign({}, originalTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors });
        return variantTheme;
    }
    /**
    ...
    function getVariant(theme, variant) {
        switch (variant) {
            ...
            default:
                return theme_1.createTheme(theme);
        }
    }
    ...
    function getNeutralVariant(theme) {
        var fullTheme = theme_1.createTheme(theme);
    ...
    function getStrongVariant(theme) {
        ...
        // Create variant palette
        var variantTheme = theme_1.createTheme({ palette: tslib_1.__assign(tslib_1.__assign({}, fullTheme.palette), partialPalette) });
        // Change semantic colors to use updated variant palette values
        variantTheme.semanticColors = tslib_1.__assign(tslib_1.__assign({}, variantTheme.semanticColors), partialSemantic);
        // Fill in the rest of the theme
        variantTheme = tslib_1.__assign(tslib_1.__assign({}, fullTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors, isInverted: !fullTheme.isInverted });
        return variantTheme;
    }
