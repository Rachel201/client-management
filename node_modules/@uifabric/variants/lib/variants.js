...
function makeThemeFromPartials(originalTheme, partialPalette, partialSemantic) {
    ...
    var variantTheme = createTheme({ palette: __assign(__assign({}, originalTheme.palette), partialPalette) });
    // Change semantic colors to use updated variant palette values
    variantTheme.semanticColors = __assign(__assign({}, variantTheme.semanticColors), partialSemantic);
    // Fill in the rest of the theme
    variantTheme = __assign(__assign({}, originalTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors });
    return variantTheme;
}
/**
...
export function getNeutralVariant(theme) {
    var fullTheme = createTheme(theme);
...
export function getStrongVariant(theme) {
    ...
    // Create variant palette
    var variantTheme = createTheme({ palette: __assign(__assign({}, fullTheme.palette), partialPalette) });
    // Change semantic colors to use updated variant palette values
    variantTheme.semanticColors = __assign(__assign({}, variantTheme.semanticColors), partialSemantic);
    // Fill in the rest of the theme
    variantTheme = __assign(__assign({}, fullTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors, isInverted: !fullTheme.isInverted });
    return variantTheme;
}
